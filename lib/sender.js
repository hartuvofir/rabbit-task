...
Sender.prototype.buildOptionsFromMsg = function (msg, headers, fields) {
  ...
  // Because we need to return the message to the queue as the first one, we need to send it with the same messageId as the first message
  // This messageId is the correlationId we received
  var options = _.extend({ correlationId: correlationId, messageId: correlationId }, fields);
