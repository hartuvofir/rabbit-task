...
Listener.prototype.start = function () {
  logger.log('[AMQP] Listener starts');
  var that = this;
...
Listener.prototype.processMsg = function (msg) {
  if (msg) {
    logger.info("[AMQP] received a msg in ", msg.fields.consumerTag);
    this.emit('msg', msg);
  }
};
...
Listener.prototype.stop = function () {
  if (this.consumerTag) {
    logger.info('[AMQP] Listener stops listening to consumer tag ' + this.consumerTag);
